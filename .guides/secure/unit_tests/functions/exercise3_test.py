...
from exercise3 import search_list
...
def test_student_code():
    ...
    # First test case
    if search_list(["Ferrari", "Porsche", "Lotus", "Tesla"], "lotus") == 2:
        test1 = True
    ...
    # Second test case
    if search_list(["Beltre", "Kinsler", "Young", "Lee"], "Lewis") == -1:
        test2 = True
    ...
    # Third test case
    if search_list(["Red", "Blue", "Orange", "Black"], "RED") == 0:
        test3 = True
